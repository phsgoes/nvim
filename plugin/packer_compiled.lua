...
_G.packer_plugins = {
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/paulo/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  sonokai = {
    loaded = true,
    path = "/home/paulo/.local/share/nvim/site/pack/packer/start/sonokai",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/paulo/.local/share/nvim/site/pack/packer/start/vim-bbye",
